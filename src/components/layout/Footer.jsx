      ...
      <div className="footer__inner">
        ...
        <div className="footer__brand">
          ...
          <p className="footer__tagline">
            Tu ferretería de confianza en Lima. Herramientas, materiales eléctricos y todo para tu obra.
          </p>
          <div className="footer__socials">
            <a href="https://wa.me/51999999999" className="footer__social-btn" target="_blank" rel="noreferrer" aria-label="WhatsApp">
